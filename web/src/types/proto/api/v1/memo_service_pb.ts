...
/**
 * @generated from message memos.api.v1.AddMemoAttachmentsRequest
 */
export type AddMemoAttachmentsRequest = Message<"memos.api.v1.AddMemoAttachmentsRequest"> & {
  /**
   * Required. The resource name of the memo.
   * Format: memos/{memo}
   *
  ...
  /**
   * Required. The attachments to add to the memo.
   *
   * @generated from field: repeated memos.api.v1.Attachment attachments = 2;
   */
  attachments: Attachment[];
...
/**
 * Describes the message memos.api.v1.AddMemoAttachmentsRequest.
 * Use `create(AddMemoAttachmentsRequestSchema)` to create a new message.
 */
export const AddMemoAttachmentsRequestSchema: GenMessage<AddMemoAttachmentsRequest> = /*@__PURE__*/
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.AddMemoAttachments
   */
  addMemoAttachments: {
    methodKind: "unary";
    input: typeof AddMemoAttachmentsRequestSchema;
    output: typeof EmptySchema;
  },
  /**
